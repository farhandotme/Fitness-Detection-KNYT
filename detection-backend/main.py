...
from src.routes.lower_body.standingSideLegRaiseRoutes import (
    router as standingSideLegRaiseRouter,
)
...
app.include_router(squatJacksRouter, prefix="/ws", tags="squat-jacks-router")
app.include_router(battleRopeRouter, prefix="/ws", tags="battle-rope-router")
...
app.include_router(
    standingSideLegRaiseRouter, prefix="/ws", tags="standing-side-leg-raise-router"
)
app.include_router(
...
app.include_router(
    skierJumpingJacksRouter, prefix="/ws", tags="skier-jumping-jacks-router"
)
app.include_router(
