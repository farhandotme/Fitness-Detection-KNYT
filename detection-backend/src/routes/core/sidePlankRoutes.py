...
async def side_plank(websocket: WebSocket):
    ...
    try:
        ...
        while True:
            ...
            exercise_logged = _log_hold_progress("Side Plank", result, exercise_logged)
