...
from src.detectors.lower_body.frog_jumps import FrogJumpSession
...
@router.websocket("/frog_jumps")
async def frog_jumps(websocket: WebSocket):
    await websocket.accept()

    print("Client connected: Frog Jumps")
    ...
    try:
        ...
        while True:
            ...
            exercise_logged = _log_rep_progress("Frog Jumps", result, exercise_logged)

            await websocket.send_json(result)
            await asyncio.sleep(0.001)

    except WebSocketDisconnect:
        print("Disconnected: Frog Jumps")
