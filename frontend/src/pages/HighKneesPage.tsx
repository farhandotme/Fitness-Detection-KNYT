...
import useHighKneesSocket from "../hooks/useHighKneesSocket";
import HighKneesCamera from "../conponents/HighKneesCamera";
import HighKneesStatsPanel from "../conponents/HighKneesStatsPanel";
...
function HighKneesPage() {
  ...
  // `session_complete` is computed server-side (HighKneeAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "high-knees", repsPerSet, totalSets }
  ...
  return (
    <div className="bicep-page highknees-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          <button
            className="highknees-back-btn"
            onClick={() => navigate("/exercises")}
          >
            ← Library
          </button>
          <h1 className="bicep-title">High Knees Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="highknees-setup-tip">
                ...
                Drive one knee up toward hip height at a time and alternate —
                each knee drive counts as its own rep, and the coach will flag
                it if you don't alternate.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <HighKneesStatsPanel data={result} />
