...
import usePlankHoldSocket from "../hooks/usePlankHoldSocket";
import PlankHoldCamera from "../conponents/PlankHoldCamera";
import PlankHoldStatsPanel from "../conponents/PlankHoldStatsPanel";
...
function PlankHoldPage() {
  ...
  // `session_complete` is computed server-side (PlankHoldAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "plank-hold", holdTarget, totalSets }
    ...
    <div className="bicep-page plank-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          ...
          <h1 className="bicep-title">Plank Hold Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="plank-setup-tip">
                Get sideways to the camera in forearm plank position — elbows
                under shoulders, body in a straight line from head to feet. The
                timer only runs while your form checks out, and it never loses
                progress you've already earned — if you break form it just
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <PlankHoldStatsPanel data={result} />
