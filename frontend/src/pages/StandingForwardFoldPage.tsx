...
import useStandingForwardFoldSocket from "../hooks/useStandingForwardFoldSocket";
import StandingForwardFoldCamera from "../conponents/StandingForwardFoldCamera";
import StandingForwardFoldStatsPanel from "../conponents/StandingForwardFoldStatsPanel";
import "./BicepPage.css";
import "./StandingForwardFoldPage.css";
...
function StandingForwardFoldPage() {
  ...
  // `session_complete` is computed server-side (StandingForwardFoldAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "standing-forward-fold", holdTarget, totalSets }
  ...
  return (
    <div className="bicep-page forward-fold-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          <button
            className="forward-fold-back-btn"
            onClick={() => navigate("/exercises")}
          >
            ← Library
          </button>
          <h1 className="bicep-title">Standing Forward Fold Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="forward-fold-setup-tip">
                Stand side-on to the camera, feet together, then hinge at your
                hips and let your torso hang down toward your legs. The timer
                only runs while your form checks out — legs standing (not
                squatting) and torso genuinely folded — and it never loses
                progress you've already earned; if you stand back up it just
                pauses until you fold again.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <StandingForwardFoldStatsPanel data={result} />
...
export default StandingForwardFoldPage;
