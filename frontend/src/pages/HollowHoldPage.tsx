...
import useHollowHoldSocket from "../hooks/useHollowHoldSocket";
import HollowHoldCamera from "../conponents/HollowHoldCamera";
import HollowHoldStatsPanel from "../conponents/HollowHoldStatsPanel";
import "./HollowHoldPage.css";
...
function HollowHoldPage() {
  ...
  // `session_complete` is computed server-side (HollowHoldAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "hollow_hold", holdTarget, totalSets }
  ...
  return (
    <div className="hollow-page">
      <div className="hollow-header">
        <div className="hollow-header-left">
          <h1 className="hollow-title">Hollow Hold Trainer</h1>
        </div>

        <div className="hollow-header-right">
          {phase === "active" && (
      ...
      {socketError && <div className="hollow-error">{socketError}</div>}
      {cameraError && <div className="hollow-error">{cameraError}</div>}

      <div className="hollow-body">
        <div className="hollow-camera-col">
          <HollowHoldCamera
            active={phase === "active"}
            sendFrame={sendFrame}
            skeleton={skeleton}
        ...
        <div className="hollow-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="hollow-setup-tip">
                Lie on your back, side-on to the camera, whole body in frame.
                Press your lower back into the mat, lift your shoulders and legs
                slightly off the ground, knees straight, arms reaching overhead.
                The timer only runs while your shoulders and legs are both
                confirmed lifted — it pauses the instant either one touches back
                down.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <HollowHoldStatsPanel data={result} />
          ...
          {phase === "complete" && (
            <div className="results-panel">
              ...
              <div className="results-table">
                <div className="results-row results-head hollow-results-row">
                  <span>Set</span>
                  <span>Held</span>
                  <span>Best</span>
                  <span>Breaks</span>
                ...
                {setSummaries.map((s) => (
                  <div
                    key={s.setNumber}
                    className="results-row hollow-results-row"
                  >
