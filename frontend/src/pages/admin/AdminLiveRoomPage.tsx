...
const STATUS_LABEL: Record<string, string> = {
  ...
  FULL: "Lobby full - game starting shortly",
  COUNTDOWN: "Pre-game countdown in progress",
  ROUND_RUNNING: "Round currently actively running",
  ROUND_FINISHED: "Round finished - tallying scores",
  BREAK: "Players are currently on a break",
  COMPLETED: "Event fully completed",
  ABANDONED: "Event abandoned due to lost connections",
};
...
export function AdminLiveRoomPage() {
  ...
  return (
    <AdminShell>
      ...
      <div className="bg-secondary/40 border border-secondary p-4 rounded-2xl mb-6 flex items-start gap-3">
        <Info className="w-5 h-5 text-muted-foreground shrink-0 mt-0.5" />
        <div>
          <h3 className="text-sm font-bold text-foreground">Spectator Mode</h3>
          <p className="text-xs text-muted-foreground mt-1">
            You are viewing this room exactly as it happens in real-time. You
            cannot interact or interfere with the game state from this view.
          </p>
        </div>
      </div>
