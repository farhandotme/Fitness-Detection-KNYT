...
import useArnoldPressSocket from "../hooks/useArnoldPressSocket";
import ArnoldPressCamera from "../conponents/ArnoldPressCamera";
import ArnoldPressStatsPanel from "../conponents/ArnoldPressStatsPanel";
import "../pages/BicepPage.css";
import "./ArnoldPressPage.css";

// Shoulders, hips, and both full arms — a two-arm overhead press needs
// both sides drawn, not just one like a single-limb exercise would.
...
function ArnoldPressPage() {
  ...
  // `session_complete` is computed server-side (ArnoldPressAnalyzer),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "arnold-press", repsPerSet, totalSets }
  ...
  return (
    <div className="bicep-page arnold-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          <h1 className="bicep-title">Arnold Press Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="arnold-setup-tip">
                Start with dumbbells at shoulder height, palms facing you
                (the "rack" position). Press both arms up together,
                rotating so your palms face forward at the top, then lower
                back to the rack with control. Standing or seated both
                work — camera should be front-on with room above your
                head for the overhead reach.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <ArnoldPressStatsPanel data={result} />
...
export default ArnoldPressPage;
