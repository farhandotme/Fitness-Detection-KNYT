...
import useTuckJumpSocket from "../hooks/useTuckJumpSocket";
import TuckJumpCamera from "../conponents/TuckJumpCamera";
import TuckJumpStatsPanel from "../conponents/TuckJumpStatsPanel";
import "./BicepPage.css";
import "./PushupPage.css";
import "./PlankHoldPage.css"; // only used here for the .plank-back-btn style
...
function TuckJumpPage() {
  ...
  // `session_complete` is computed server-side (TuckJumpAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "tuck-jump", repsPerSet, totalSets }
    ...
    <div className="bicep-page pushup-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          ...
          <h1 className="bicep-title">Tuck Jump Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="pushup-setup-tip">
                Stand facing the camera, whole body in frame, arms extended
                straight out in front. Jump and drive both knees up toward your
                chest, then land back to standing — reps only count once both
                knees actually tuck up together, so a partial bend or a
                one-sided knee lift won't register.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <TuckJumpStatsPanel data={result} />
