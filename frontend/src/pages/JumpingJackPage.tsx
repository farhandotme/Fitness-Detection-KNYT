          ...
          {phase === "setup" && (
            <div className="session-builder">
              ...
              <div className="squat-setup-tip">
                Stand far enough back that your whole body is in frame, arms at
                your sides — hold still for a second so the coach can calibrate
                your posture before you start.
              </div>
