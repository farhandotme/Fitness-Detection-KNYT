...
import useShoulderPressSocket from "../hooks/useShoulderPressSocket";
import ShoulderPressCamera from "../conponents/ShoulderPressCamera";
import ShoulderPressStatsPanel from "../conponents/ShoulderPressStatsPanel";
        ...
        <div className="bicep-stats-col">
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <ShoulderPressStatsPanel data={result} />
...
export default ShoulderPressPage;
