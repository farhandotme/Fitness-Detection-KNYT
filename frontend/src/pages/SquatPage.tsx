...
import useSquatSocket from "../hooks/useSquatSocket";
import SquatCamera from "../conponents/SquatCamera";
import SquatStatsPanel from "../conponents/SquatStatsPanel";
...
function SquatPage() {
  ...
  // `session_complete` is computed server-side (SquatAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "squat", repsPerSet, totalSets }
    ...
    <div className="bicep-page squat-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          <h1 className="bicep-title">Squat Trainer</h1>
        </div>
          ...
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="squat-setup-tip">
                Stand far enough back that your whole body — head to feet — is
                in frame. Face the camera (or stand at a slight angle) so both
                legs are visible.
              </div>
