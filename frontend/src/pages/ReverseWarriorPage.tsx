...
import useReverseWarriorSocket from "../hooks/useReverseWarriorSocket";
import ReverseWarriorCamera from "../conponents/ReverseWarriorCamera";
import ReverseWarriorStatsPanel from "../conponents/ReverseWarriorStatsPanel";
import "./BicepPage.css";
import "./PlankHoldPage.css";
import "./ReverseWarriorPage.css";
...
function ReverseWarriorPage() {
  ...
  // `session_complete` is computed server-side (ReverseWarriorAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "reverse-warrior", holdTarget, totalSets }
  ...
  return (
    <div className="bicep-page rw-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          ...
          <h1 className="bicep-title">Reverse Warrior Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="rw-setup-tip">
                Face the camera in a wide lunge stance, front knee bent and
                back leg straight. Reach your front-side arm straight up
                overhead while your back-side arm rests down along your back
                leg, arcing your torso into a backbend over that back leg.
                The timer only runs while ALL of your stance, both knees, both
                arms, and your torso arc check out — a lunge with just one arm
                up, or standing upright, won't count. It never loses progress
                you've already earned — if form breaks it just pauses until
                you're back in position.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <ReverseWarriorStatsPanel data={result} />
...
export default ReverseWarriorPage;
