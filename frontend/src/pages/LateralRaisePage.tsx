...
import useLateralRaiseSocket from "../hooks/useLateralRaiseSocket";
import LateralRaiseCamera from "../conponents/LateralRaiseCamera";
import LateralRaiseStatsPanel from "../conponents/LateralRaiseStatsPanel";
import "./BicepPage.css";
import "./LateralRaisePage.css";
...
const REST_PRESETS = [30, 45, 60, 75];
...
function LateralRaisePage() {
  ...
  // `session_complete` is computed server-side (LateralRaiseAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "lateral-raise", repsPerSet, totalSets }
  ...
  return (
    <div className="bicep-page lateralraise-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          <button
            className="lateralraise-back-btn"
            onClick={() => navigate("/exercises")}
          >
            ← Library
          </button>
          <h1 className="bicep-title">Lateral Raise Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="lateralraise-setup-tip">
                Stand tall facing the camera with your whole torso and both arms
                in frame, space on both sides. Start each rep with your arms
                relaxed at your sides and raise them straight out to shoulder
                height, elbows soft but straight — the coach checks your
                posture, shoulder shrug, elbow bend, and left/right symmetry
                on every single rep.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <LateralRaiseStatsPanel data={result} />
