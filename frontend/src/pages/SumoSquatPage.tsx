...
import useSumoSquatSocket from "../hooks/useSumoSquatSocket";
import SumoSquatCamera from "../conponents/SumoSquatCamera";
import SumoSquatStatsPanel from "../conponents/SumoSquatStatsPanel";
import "./SumoSquatPage.css";
...
function SumoSquatPage() {
  ...
  // `session_complete` is computed server-side (SumoSquatAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "sumo_squat", repsPerSet, totalSets }
  ...
  return (
    <div className="sumo-page">
      <div className="sumo-header">
        <div className="sumo-header-left">
          <h1 className="sumo-title">Sumo Squat Trainer</h1>
        </div>

        <div className="sumo-header-right">
          {phase === "active" && (
      ...
      {socketError && <div className="sumo-error">{socketError}</div>}
      {cameraError && <div className="sumo-error">{cameraError}</div>}

      <div className="sumo-body">
        <div className="sumo-camera-col">
          <SumoSquatCamera
            active={phase === "active"}
            sendFrame={sendFrame}
            skeleton={skeleton}
        ...
        <div className="sumo-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="sumo-setup-tip">
                Stand facing the camera in a wide sumo stance — feet turned
                out, noticeably wider than shoulder-width, holding your
                weight with both hands between your legs. Squat straight
                down keeping your chest up and knees tracking over your
                toes. Reps only count once a real wide sumo stance is
                confirmed and you hit real depth.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <SumoSquatStatsPanel data={result} />
