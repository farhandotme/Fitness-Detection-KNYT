...
import usePeacockPoseSocket from "../hooks/usePeacockPoseSocket";
import PeacockPoseCamera from "../conponents/PeacockPoseCamera";
import PeacockPoseStatsPanel from "../conponents/PeacockPoseStatsPanel";
import "./BicepPage.css";
import "./PeacockPosePage.css";
...
function PeacockPosePage() {
  ...
  // `session_complete` is computed server-side (PeacockPoseAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "peacock-pose", holdTarget, totalSets }
  ...
  return (
    <div className="bicep-page peacock-page">
      <div className="bicep-header">
        <div className="bicep-header-left">
          <button
            className="peacock-back-btn"
            onClick={() => navigate("/exercises")}
          >
            ← Library
          </button>
          <h1 className="bicep-title">Peacock Pose Trainer</h1>
        </div>
        ...
        <div className="bicep-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="peacock-setup-tip">
                Side-on to the camera: hands flat on the floor, arms straight,
                shoulders leaned forward past your hands, body extended into one
                straight line, hovering off the ground. The timer only runs
                while your arms stay straight, the lean is genuine, and your
                body line stays straight — it pauses (never loses progress) the
                moment any of those breaks, and resumes the instant you're back
                in position.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <PeacockPoseStatsPanel data={result} />
...
export default PeacockPosePage;
