...
import useSideLegSwingSocket from "../hooks/useSideLegSwingSocket";
import SideLegSwingCamera from "../conponents/SideLegSwingCamera";
import SideLegSwingStatsPanel from "../conponents/SideLegSwingStatsPanel";
import "../exercise-shared.css";
import "./SideLegSwingPage.css";
...
function SideLegSwingPage() {
  ...
  // `session_complete` is computed server-side (SideLegSwingAnalyzer._is_complete),
  ...
  useEffect(() => {
    ...
    //   POST /api/workouts/complete { exercise: "side_leg_swing", repsPerSet, totalSets }
  ...
  return (
    <div className="legswing-page">
      <div className="legswing-header">
        <div className="legswing-header-left">
          <h1 className="legswing-title">Side Leg Swing Trainer</h1>
        </div>

        <div className="legswing-header-right">
          {phase === "active" && (
      ...
      {socketError && <div className="legswing-error">{socketError}</div>}
      {cameraError && <div className="legswing-error">{cameraError}</div>}

      <div className="legswing-body">
        <div className="legswing-camera-col">
          <SideLegSwingCamera
            active={phase === "active"}
            sendFrame={sendFrame}
            skeleton={skeleton}
        ...
        <div className="legswing-stats-col">
          {phase === "setup" && (
            ...
            <div className="session-builder">
              ...
              <div className="legswing-setup-tip">
                Stand facing the camera (or back-on works too), whole body
                visible. Plant one leg and swing the other straight out to the
                side and back down, staying upright — save the other leg for a
                second set. Reps only count once the working leg swings out far
                enough and returns to rest — a confirmed standing position is
                required to start counting.
              </div>
          ...
          {phase === "resting" && (
            <div className="rest-panel">
              ...
              <div className="legswing-rest-tip">
                Switching legs? Just start swinging the other leg once the next
                set starts — the working leg is detected automatically.
              </div>
          ...
          {phase === "active" && (
            <div className="single-arm-wrap">
              <SideLegSwingStatsPanel data={result} />
...
export default SideLegSwingPage;
