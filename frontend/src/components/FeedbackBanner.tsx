...
export function FeedbackBanner({
  ...
  if (!poseDetected) {
    return (
      <div
        className={cn(
          "p-4 rounded-xl bg-destructive/10 border border-destructive/30 flex gap-3 items-start",
          className,
        )}
      >
  ...
  if (issues.length > 0) {
    return (
      <div
        className={cn(
          "p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 flex gap-3 items-start",
          className,
        )}
      >
        <AlertCircle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
        <div className="flex flex-col gap-1">
          <p className="font-bold text-amber-500 uppercase tracking-wide text-sm">
            Adjust Form
          </p>
  ...
  return (
    <div
      className={cn(
        "p-4 rounded-xl bg-primary/10 border border-primary/30 flex gap-3 items-start",
        className,
      )}
    >
      <CheckCircle2 className="w-5 h-5 text-primary shrink-0 mt-0.5" />
      <div className="flex flex-col gap-1 w-full">
        <p className="font-bold text-primary uppercase tracking-wide text-sm">
          Form Looks Good
        </p>
