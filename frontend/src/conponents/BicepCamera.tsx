 ...
 */
export default function BicepCamera({ active, sendFrame, skeleton, onError }: Props) {
  ...
  return (
    <div className="bicep-viewfinder">
      {active ? (
        <>
          <video ref={videoRef} autoPlay muted playsInline className="bicep-viewfinder-video" />
        ...
        <div className="bicep-viewfinder-placeholder">
          <span>📷</span>
          <p>Camera turns on when you hit Start</p>
        </div>
      )}
    </div>
  );
