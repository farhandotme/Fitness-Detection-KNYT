import type { StandingForwardFoldData } from "../hooks/useStandingForwardFoldSocket";

interface Props {
  data: StandingForwardFoldData | undefined;
}
...
export default function StandingForwardFoldStatsPanel({ data }: Props) {
  ...
  return (
    <div className="arm-panel plank-panel">
      <div className="arm-panel-head">
        <span className="arm-panel-label">STANDING FORWARD FOLD</span>
        <span
      ...
      <div className="arm-grid">
        ...
        <div className="arm-grid-item">
          <span className="k">Fold angle</span>
          <span className="v">
            {data?.fold_angle != null ? `${data.fold_angle.toFixed(1)}°` : "—"}
          </span>
        </div>
        <div className="arm-grid-item">
