import type { PeacockPoseData } from "../hooks/usePeacockPoseSocket";

interface Props {
  data: PeacockPoseData | undefined;
}
...
export default function PeacockPoseStatsPanel({ data }: Props) {
  ...
  return (
    <div className="arm-panel plank-panel">
      <div className="arm-panel-head">
        <span className="arm-panel-label">PEACOCK POSE</span>
        <span
      ...
      <div className="arm-grid">
        ...
        <div className="arm-grid-item">
          <span className="k">Elbow tuck</span>
          <span className="v">
            {data?.elbow_tuck_ratio != null
              ? data.elbow_tuck_ratio.toFixed(2)
              : "—"}
          </span>
        </div>
        <div className="arm-grid-item">
          <span className="k">Body line</span>
          <span className="v">
            {data?.body_line_angle != null
              ? `${data.body_line_angle.toFixed(1)}°`
              : "—"}
          </span>
        </div>
        <div className="arm-grid-item">
