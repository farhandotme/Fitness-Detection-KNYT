...
import type { Landmark } from "../hooks/useTuckJumpSocket";
...
/**
 * Tuck jumps need the WHOLE body — head to feet, plus headroom above for
 * the jump itself — visible at all times, filmed front-on. That's a
 * portrait-leaning frame (unlike push-up's landscape lean), so the ideal
 * capture size favors height over width.
 */
export default function TuckJumpCamera({
  active,
  sendFrame,
  skeleton,
  onError,
      ...
      try {
        stream = await navigator.mediaDevices.getUserMedia({
          video: {
            facingMode: "user",
            width: { ideal: 640 },
            height: { ideal: 854 }, // portrait-leaning — full body + headroom for the jump
      ...
      {active ? (
        ...
        <div className="pushup-viewfinder-placeholder">
          ...
          <p>
            ...
            your whole body (and room above your head) in frame
          </p>
        </div>
      )}
    </div>
