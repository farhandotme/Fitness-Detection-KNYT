...
import type { Landmark } from "../hooks/useSquatSocket";
...
/**
 * Always opens whatever camera the browser considers the default
 * (front-facing on phones, built-in webcam on laptops) — no device picker.
 * Same capture pipeline as BicepCamera, scoped to its own class names so it
 * can carry a full-body skeleton (legs + feet) without colliding with the
 * bicep page's styling.
 */
    ...
    <div className="squat-viewfinder">
      {active ? (
        ...
        <div className="squat-viewfinder-placeholder">
          <span>📷</span>
          <p>
            Camera turns on when you hit Start — step back for a full-body view
          </p>
        </div>
      )}
    </div>
